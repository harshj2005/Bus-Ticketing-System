...
public class UserBookingHistory extends javax.swing.JFrame {
    ...
    public  UserBookingHistory(String Us) {
        initComponents();
        this.luser=Us;
        try{
            ...
            String userSelectQuery="select * from bookings where username='"+this.luser+"'";            
            ...
            BT.setModel(DbUtils.resultSetToTableModel(rs));
                ...
                infoMessage("No Tickets found","Alert");               
            }
       }
        catch(Exception e){
    ...
    private void BTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BTMouseClicked
        ...
        ViewTicketDetails ebd=new ViewTicketDetails(ticketID);
