 ...
 * @author HOME
 */
public class ViewTicketDetails extends javax.swing.JFrame {
    ...
    public ViewTicketDetails(String tID) {
        initComponents();
        String ticket=tID;
        try{
...
public void infoMessage(String message, String title)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTicketDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
